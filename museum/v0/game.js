class Game{
    ...
    loadEnvironment(){
		...
		gltfLoader.load('../assets/glb/base.glb', (gltf) => {
			...
			gltf.scene.traverse(function(child) {
				if (child.isMesh) {
				  if (child.name.includes('main')) {
					...
					child.material.roughness = 0.8; // ajustar la rugosidad del material
					child.material.metalness = 0.5; // ajustar la metalicidad del material
